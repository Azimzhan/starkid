...
<div class="row">
    <div class="col-12 align-self-center">
        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Редактирование курса</h3>
        ...
        <div class="card mt-4">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <input type="text" id="course-name" name="course-name" class="form-control form-control-lg custom-shadow border-0" value="Проекты по Ардуино">
                        {{-- <span class="badge badge-pill badge-success mt-3">Вы изучаете этот курс</span> --}}
                        <select class="w-50 custom-select custom-select-set form-control bg-white text-secondary mt-2 border-0 custom-shadow">
            ...
            <div class="card-body">
                ...
                <div class="row border-bottom">
                    <div class="col-md-12">
                        ...
                        <p class="align-middle"><i data-feather="message-circle" class="svg-icon text-warning"></i> - 0</p>
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12 border-top pt-2">
                        <a href="" class="btn btn-primary"> 
                            <i data-feather="edit-3" class="svg-icon text-light"></i>
                            Редактировать</a>
                    </div>
                </div>
            </div>
