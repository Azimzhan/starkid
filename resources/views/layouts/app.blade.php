...
<body>
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
            ...
            <nav class="navbar top-navbar navbar-expand-md">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="{{url('/')}}">
                            <b class="logo-icon">
                               <img src="{{asset('img/logo.png')}}" class="img-fluid" alt="" style="max-width:50px; margin-top: -7px;">
        ...
        <div class="page-wrapper">
            ...
            <!-- footer -->
            <!-- ============================================================== -->
            <footer class="text-center valign-center">
                <p>Все права защишены ©Starkid <br> 
                Coded by <a href="#">Azimzhan Dauletov</a>.</p>  
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
